...
router.get('/create', authMiddleware, isAdmin, checkSuperAdmin, getCreateCategory);

router.post('/create', authMiddleware, isAdmin, createCategory);

router.get('/update/:id', authMiddleware, isAdmin, checkSuperAdmin, getUpdateCategory);
